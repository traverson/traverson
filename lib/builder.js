...
Builder.prototype.withRequestLibrary = function(request) {
  // TODO Obey Demeter!
  this.actions.walker.request = request;
  return this;
};
...
Builder.prototype.getRequestLibrary = function() {
  // TODO Obey Demeter!
  return this.actions.walker.request;
};
...
Builder.prototype.get = function(callback) {
  var walkState = createInitialWalkerState(this);
  return this.actions.get(walkState, callback);
};
...
Builder.prototype.getResource = function(callback) {
  var walkState = createInitialWalkerState(this);
  return this.actions.getResource(walkState, callback);
};
...
Builder.prototype.getUri = function(callback) {
  var walkState = createInitialWalkerState(this);
  return this.actions.getUri(walkState, callback);
};
...
Builder.prototype.post = function(body, callback) {
  var walkState = createInitialWalkerState(this, body);
  return this.actions.post(walkState, callback);
};
...
Builder.prototype.put = function(body, callback) {
  var walkState = createInitialWalkerState(this, body);
  return this.actions.put(walkState, callback);
};
...
Builder.prototype.patch = function(body, callback) {
  var walkState = createInitialWalkerState(this, body);
  return this.actions.patch(walkState, callback);
};
...
Builder.prototype.delete = function(callback) {
  var walkState = createInitialWalkerState(this);
  return this.actions.delete(walkState, callback);
};
...
function createInitialWalkerState(self, body) {
  ...
  walkState.abortTraversal = abortTraversal.bind(walkState);
  return walkState;
}
