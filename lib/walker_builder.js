({
  ...
  './dependencies/browser/request',
  './dependencies/browser/util',
  './json_walker',
  './json_hal_walker',
  './log',
  './media_types'
...
function WalkerBuilder(mediaType, startUri) {
  ...
  this.walker.request = this.request = new StandardRequest()
}
...
WalkerBuilder.prototype.withRequestOptions = function(options) {
  this.walker.request = this.request = new StandardRequest().defaults(options)
  return this
}
...
WalkerBuilder.prototype.executeRequest = function(uri, method, body,
  ...
  method(uri, options, function(err, response) {
