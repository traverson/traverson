...
* [Minified require/external build](https://raw.github.com/basti1302/traverson/master/browser/dist/): Created with browserify's `--require` parameter and intended to be used (required) from other browserified modules, which were created with `--external traverson`. This build could be used if you use browserify but do not want to bundle Traverson with your own browserify build but keep it as a separate file.
* [Non-minified require/external build](https://raw.github.com/basti1302/traverson/master/browser/dist/): Same as before, just bigger.
