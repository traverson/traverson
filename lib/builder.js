...
var FinalAction = require('./final_action')
  ...
  , JsonAdapter = require('./json_adapter')
  , JsonHalAdapter = require('./json_hal_adapter')
...
Builder.prototype.createAdapter = function(mediaType) {
  ...
  case mediaTypes.JSON:
    log.debug('creating new JsonAdapter');
    return new JsonAdapter();
  case mediaTypes.JSON_HAL:
    log.debug('creating new JsonHalAdapter');
    return new JsonHalAdapter();
  default:
