...
Builder.prototype.addRequestOptions = function(options) {
  ...
  // case 1: both the present options and the new options are arrays.
  ...
  // case 2: there is an options object the new options are an array.
  ...
  // case 3: there is an options array and the new options are an object.
