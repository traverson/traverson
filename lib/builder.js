...
Builder.prototype.get = function(callback) {
  var self = this;
  this.walker.walk(self.links, function(err, nextStep, lastStep) {
  ...
  return createTraversalHandle(self);
};
...
Builder.prototype.post = function(body, callback) {
  this.finalAction.walkAndExecute(
      this.links, body, this.request, this.getRequestOptions(),
...
Builder.prototype.put = function(body, callback) {
  this.finalAction.walkAndExecute(this.links, body, this.request,
      this.getRequestOptions(), this.request.put, callback);
  return createTraversalHandle(this);
};
...
Builder.prototype.patch = function(body, callback) {
  this.finalAction.walkAndExecute(this.links, body, this.request,
      this.getRequestOptions(), this.request.patch, callback);
  return createTraversalHandle(this);
};
...
Builder.prototype.delete = function(callback) {
  this.finalAction.walkAndExecute(this.links, null, this.request,
      this.getRequestOptions(), this.request.del, callback);
  return createTraversalHandle(this);
};
